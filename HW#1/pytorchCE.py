...
def train(model,dataloaderTrain,dataloaderVal,optimizer,lossFunc,epochs,device):
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if epoch % 1 == 0:
            ...
            if lossVal < bestVal:
                bestVal = lossVal
                torch.save(model.state_dict(),'/Users/maxbengtsson/Desktop/Python/Spring 2025/CS 449/HW#1/weights/weightsCE.pth')
...
def testScore(model,dataloader,device):
    ...
    model.load_state_dict(torch.load('/Users/maxbengtsson/Desktop/Python/Spring 2025/CS 449/HW#1/weights/weightsCE.pth'))
